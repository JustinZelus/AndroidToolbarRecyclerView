...
public class Directory_Sample_Fragment extends Fragment implements RecyclerViewClickListener{
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        myDataset = new OffLine(MainActivity.Instance.getDirectory_Names_Sample(),resources.obtainTypedArray(R.array.directoryRipples));
    }
