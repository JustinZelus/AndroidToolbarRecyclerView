...
public class Directory_User_Library_Fragment extends Fragment implements RecyclerViewClickListener{
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        myDataset = new OffLine(MainActivity.Instance.getDirectory_Names_User_Library(),resources.obtainTypedArray(R.array.directoryRipples));
    }
